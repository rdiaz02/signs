...
# os.system('echo "\n\ntmpDir = ' + tmpDir + '" >> /home2/ramon/web-apps/apache-logs/signs_procs.log')
# os.system('echo "numRsigns = ' + str(numRsigns) + '" >> /home2/ramon/web-apps/apache-logs/signs_procs.log')
# os.system('echo "MAX_signs = ' + str(MAX_signs) + '" >> /home2/ramon/web-apps/apache-logs/signs_procs.log')
