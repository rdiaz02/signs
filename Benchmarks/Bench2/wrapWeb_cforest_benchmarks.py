...
def launchUTests(test, users):
    ...
    for uu in range(users):
        iin, t[uu] = os.popen2('fl-run-test benchmarkSigns_cforest.py Signs.' + test + '_cforest')
        time.sleep(5)
    for uu in range(users):
...
try:
    ...
    None
writeFile(breast_10_1, 'breast.web.cforest.10_1.txt')
   
try:
    dlbcl_10_1 = launchUTests('dlbcl', 10)
except:
    None
writeFile(dlbcl_10_1, 'dlbcl.web.cforest.10_1.txt')
...
try:
    ...
    None
writeFile(breast_15_1, 'breast.web.cforest.15_1.txt')
   
try:
    dlbcl_15_1 = launchUTests('dlbcl', 15)
except:
    None
writeFile(dlbcl_15_1, 'dlbcl.web.cforest.15_1.txt')
...
breastA = breast_1_1 + breast_1_2 + breast_1_3 + breast_1_4 + breast_1_5 +\
          breast_5_1 
writeFile(breastA, 'breastA.web.cforest.txt')
...
dlbclA = dlbcl_1_1 + dlbcl_1_2 + dlbcl_1_3 + dlbcl_1_4 + dlbcl_1_5 +\
         dlbcl_5_1 
writeFile(dlbclA, 'dlbclA.web.cforest.txt')
